            ...
            <View style={styles.socialRow}>
              <TouchableOpacity
                ...
                onPress={async () => {
                  ...
                  try {
                    ...
                    // Route only after auth state settles to avoid
                    // onboarding race conditions right after sign-in.
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  Alert.alert(
                    "Coming Soon 🍎",
                    "Apple Login will be available in the next update! We are currently working on the final approval.",
                  )
                }
              >
